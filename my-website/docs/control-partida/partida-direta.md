...
![Comando da partida direta](./part.direta.jpeg)

## Comando da partida no diagrama:

![Diagrama da partida direta no diagrama](./diret.diagr.png)
...
![Comando de força da partida direta](./part.forca.direta.jpg.jpeg)

## Comando de força no diagrama:

![Diagrama de força da partida direta no diagrama](./direta.diagr.png)
