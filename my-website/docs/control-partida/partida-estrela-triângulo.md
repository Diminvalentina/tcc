...
![Comando de força da partida estrela triângulo](./estre.comand.png)

## Comando de força no diagrama:

![Diagrama de força da partida estrela triângulo no diagrama](./estre.comand.diagr.png)
...
## Comando de força:
![Comando de força da partida estrela triângulo](./forca.estre.tri.jpg.jpeg)

## Comando de força no diagrama:

![Diagrama de força da partida estrela triângulo no diagrama](./estre.tri.driagrama.png)
